...
module.exports = function(debug, i18next, options) { 
	...
	var localisedFilePath = helpers(i18next, {path:()=>options.path, fallbackLng:options.fallbackLng, omitFallbackLng:options.omitFallbackLng}).localisedFilePath,
				...
				options.locales.forEach(function(locale){
					...
					let h = helpers(i18next, {
					    	...
					    	path:      () => options.path,
								...
								omitFallbackLng: options.omitFallbackLng
					    })
